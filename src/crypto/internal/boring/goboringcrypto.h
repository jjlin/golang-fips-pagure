...
_goboringcrypto_DLOPEN_OPENSSL(void)
{
	...
	handle = dlopen("libcrypto.so", RTLD_LAZY | RTLD_GLOBAL);
	return handle;
}
...
DEFINEFUNC(const GO_EVP_MD *, EVP_md5_sha1, (void), ())
...
DEFINEFUNC(size_t, EVP_MD_size, (const GO_EVP_MD *arg0), (arg0))
...
DEFINEFUNC(size_t, HMAC_size, (const GO_HMAC_CTX *arg0), (arg0))
...
DEFINEFUNC(unsigned int, BN_num_bytes, (const GO_BIGNUM *arg0), (arg0))
...
DEFINEFUNC(int, RSA_verify,
		   ...
		   (arg0, arg1, arg2, arg3, arg4, arg5))
DEFINEFUNC(void, RSA_get0_key,
		   (const GO_RSA *rsa, const GO_BIGNUM **n, const GO_BIGNUM **e, const GO_BIGNUM **d),
		   (rsa, n, e, d))
DEFINEFUNC(void, RSA_get0_factors,
		   (const GO_RSA *rsa, const GO_BIGNUM **p, const GO_BIGNUM **q),
		   (rsa, p, q))
DEFINEFUNC(void, RSA_get0_crt_params,
		   (const GO_RSA *rsa, const GO_BIGNUM **dmp1, const GO_BIGNUM **dmp2, const GO_BIGNUM **iqmp),
		   (rsa, dmp1, dmp2, iqmp))
DEFINEFUNC(int, RSA_set0_key,
		   (GO_RSA * rsa, GO_BIGNUM *n, GO_BIGNUM *e, GO_BIGNUM *d),
		   (rsa, n, e, d))
DEFINEFUNC(int, RSA_set0_factors,
		   (GO_RSA * rsa, GO_BIGNUM *p, GO_BIGNUM *q),
		   (rsa, p, q))
DEFINEFUNC(int, RSA_set0_crt_params,
...
DEFINEFUNC(int, EVP_PKEY_CTX_set_rsa_padding, (GO_EVP_PKEY_CTX * arg0, int padding), (arg0, padding))
DEFINEFUNC(int, EVP_PKEY_CTX_set_signature_md, (EVP_PKEY_CTX *ctx, const EVP_MD *md), (ctx, md))
...
DEFINEFUNC(int, EVP_PKEY_CTX_set_rsa_mgf1_md, (GO_EVP_PKEY_CTX * arg0, const GO_EVP_MD *arg1), (arg0, arg1))
DEFINEFUNC(int, EVP_PKEY_CTX_set_rsa_pss_saltlen, (GO_EVP_PKEY_CTX * arg0, int arg1), (arg0, arg1))
